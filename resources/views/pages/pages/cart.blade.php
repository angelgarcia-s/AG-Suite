                                              ...
                                              <tbody>
                                                      ...
                                                      <td>
                                                          <div class="flex items-center">
                                                              <div class="hs-tooltip ti-main-tooltip">
                                                                  <button type="button" class="hs-tooltip-toggle ti-btn ti-btn-icon bg-success text-white !font-medium me-1">
                                                              ...
                                                              <div class="hs-tooltip ti-main-tooltip ltr:[--placement:left] rtl:[--placement:right]">
                                                                  <button type="button" class="hs-tooltip-toggle ti-btn ti-btn-icon bg-danger text-white !font-medium btn-delete">
                                                  ...
                                                  <tr class="border border-inherit border-solid">
                                                      ...
                                                      <td>
                                                          <div class="flex items-center">
                                                              <div class="hs-tooltip ti-main-tooltip">
                                                                  <a href="{{url('wishlist')}}" class="hs-tooltip-toggle ti-btn ti-btn-icon bg-success text-white !font-medium me-1">
                                                                      <i class="ri-heart-line"></i>
                                                                      <span
                                                                          class="hs-tooltip-content  ti-main-tooltip-content py-1 px-2 !bg-black !text-xs !font-medium !text-white shadow-sm "
                                                                          role="tooltip">
                          ...
                          <div class="xxl:col-span-3 col-span-12">
                              <div class="box">
                                  ...
                                  <div class="box-body !p-0">
                                      ...
                                      <div class="p-4 grid">
                                          <a href="{{url('checkout')}}" class="ti-btn bg-primary  text-white !font-medium !mb-2">Proceed To Checkout</a>
                                          <a href="{{url('products')}}" class="ti-btn bg-light  !font-medium">Countinue Shopping</a>
                                      </div>
                                  </div>
                              </div>
                          </div>
