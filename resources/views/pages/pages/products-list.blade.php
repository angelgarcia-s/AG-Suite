...
@section('content')
                      ...
                      <div class="block justify-between page-header md:flex">
                          <div>
                              <h3 class="!text-defaulttextcolor text-[1.125rem] font-semibold"> Products List</h3>
                          </div>
                              ...
                              <div class="box">
                                  ...
                                  <div class="box-body">
                                      ...
                                      <div class="sm:flex items-center justify-between flex-wrap">
                                          ...
                                          <button type="button" class="ti-btn bg-danger text-white !font-medium m-1">Delete All</button>
                                      </div>
                                  </div>
                              </div>
                          </div>
