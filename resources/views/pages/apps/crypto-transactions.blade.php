...
@section('content')
                        ...
                        <div class="block justify-between page-header md:flex">
                            <div>
                                <h3 class="!text-defaulttextcolor text-[1.125rem] font-semibold">Transactions</h3>
                            </div>
                                ...
                                <div class="box custom-box">
                                    <div class="box-header justify-between">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <div>
                                                <button type="button" class="ti-btn ti-btn-secondary-full !py-1 !px-2 !text-[0.75rem] btn-wave">View All</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-body">
                                ...
                                <div class="box custom-box">
                                    <div class="box custom-box">
                                        <div class="box-body !p-0">
                                            <div class="p-6 border-b border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <div class="pb-0 mt-0">
                                                        <div>
                                                            <h4 class="text-[1.125rem] font-semibold mb-2"><span class="count-up" data-count="42">42</span><span class="text-[#8c9097] ltr:float-right rtl:float-left text-[.6875rem] font-normal">Last Year</span></h4>
                                            ...
                                            <div class="p-4 border-b border-dashed flex items-start flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <div>
                                                        <h4 class="text-[1.125rem] font-semibold mb-2"><span class="count-up" data-count="319">320</span><span class="text-[#8c9097] ltr:float-right rtl:float-left text-[.6875rem] font-normal">Last Year</span></h4>
                                                        <p class="text-[#8c9097] text-[.6875rem] mb-0 leading-none">
                                            ...
                                            <div class="flex items-start p-4 border-b border-dashed flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <div>
                                                        <h4 class="text-[1.125rem] font-semibold mb-2"><span class="count-up" data-count="81">82</span><span class="text-[#8c9097] ltr:float-right rtl:float-left text-[.6875rem] font-normal">Last Year</span></h4>
                                                        <p class="text-[#8c9097] text-[.6875rem] mb-0 leading-none">
                                                            <span class="text-success me-1 font-semibold">
                                            ...
                                            <div class="flex items-start p-4 border-b border-dashed flex-wrap gap-2">
                                                ...
                                                <div class="flex-grow">
                                                    ...
                                                    <div>
                                                        <h4 class="text-[1.125rem] font-semibold mb-2"><span class="count-up" data-count="32">33</span><span class="text-[#8c9097] ltr:float-right rtl:float-left text-[.6875rem] font-normal">Last Year</span></h4>
                                                        <p class="text-[#8c9097] text-[.6875rem] mb-0 leading-none">
                                            ...
                                            <div class="p-6 pb-2">
                                                <p class="text-[.9375rem] font-semibold">Transactions Statistics <span class="text-[#8c9097] font-normal">(Last 6 months) :</span></p>
