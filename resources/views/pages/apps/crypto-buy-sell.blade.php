                                        ...
                                        <div class="box-body">
                                            <div>
                                                <div class="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
                                                    <input type="text" class="form-control crypto-buy-sell-input border-e-0" aria-label="crypto buy select" placeholder="Select Currency">
                                                ...
                                                <div class="input-group mb-4 sm:flex block flex-nowrap crypto-buy-sell">
                                                    <input type="text" class="form-control crypto-buy-sell-input border-e-0" aria-label="crypto buy select" placeholder="36,335.00">
