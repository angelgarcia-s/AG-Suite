                                ...
                                <div class="box custom-box">
                                    <div class="box-header flex items-center justify-between flex-wrap gap-4">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            <a href="javascript:void(0);" class="hs-dropdown-toggle ti-btn ti-btn-primary-full !py-1 !px-2 !text-[0.75rem]" data-hs-overlay="#todo-compose"><i class="ri-add-line font-semibold align-middle"></i>Create Lead
                                            </a>
                                    ...
                                    <div class="box-body !p-0">
                                        <div class="table-responsive xxl:overflow-auto">
                                            <table class="table whitespace-nowrap min-w-full">
                                                ...
                                                <tbody>
                                                    <tr class="border border-defaultborder crm-contact min-w-full">
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="btn-list">
                                                                <a  aria-label="anchor" href="javascript:void(0);" class="ti-btn ti-btn-sm ti-btn-warning"><i class="ri-eye-line"></i></a>
                                                    ...
                                                    <tr class="border border-defaultborder crm-contact">
                                                        <td>
                                                    ...
                                                    <tr class="border border-defaultborder crm-contact">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center flex-wrap gap-1">
                                                                <span class="badge bg-pink/10 text-pink">Subscriber</span>
                                                                <span class="badge bg-success/10 text-success">Partner</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="border border-defaultborder crm-contact">
                                                        ...
                                                        <td>
                                                            <div class="flex items-center flex-wrap gap-1">
                                                                ...
                                                                <span class="badge bg-purple/10 text-purple">Cold Lead</span>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="btn-list">
