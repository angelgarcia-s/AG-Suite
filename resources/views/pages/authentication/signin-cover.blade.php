                              ...
                              <div class="grid grid-cols-12 gap-y-4">
                                  ...
                                  <div class="xl:col-span-12 col-span-12 mb-4">
                                      ...
                                      <div class="input-group">
                                          <input type="password" class="form-control form-control-lg !rounded-e-none" id="signin-password" placeholder="password">
                                  ...
                                  <div class="xl:col-span-12 col-span-12 grid mt-2">
                                      <a href="{{url('index')}}" class="ti-btn ti-btn-lg bg-primary text-white !font-medium">Sign In</a>
                                  </div>
                              </div>
                              <div class="text-center">
                                  <p class="text-[0.75rem] text-[#8c9097] mt-4">Dont have an account? <a href="{{url('signup-cover')}}" class="text-primary">Sign Up</a></p>
                              </div>
                          </div>
                      </div>
                      <div class="xxl:col-span-3 xl:col-span-3 lg:col-span-3 md:col-span-3 sm:col-span-2"></div>
