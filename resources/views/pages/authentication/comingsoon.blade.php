                            ...
                            <div class="p-0 md:p-7">
                                <div class="text-center">
                                    ...
                                    <div class="input-group mb-[3em]">
                                        <input type="email" class="form-control w-full !rounded-s-md form-control-lg " placeholder="info@gmail.com" aria-label="info@gmail.com" aria-describedby="button-addon2">
                                        <button class="ti-btn bg-primary text-white !rounded-s-none !mb-0" type="button" id="button-addon2">Subscribe</button>
                                    </div>
                                    <div class="grid grid-cols-12 mt-6 mb-[3rem] xxl:gap-y-0 gap-4 justify-center" id="timer">
                                    </div>
                                    <div class="mt-[3rem]">
                                        <div class="btn-list">
                                            <button aria-label="button" type="button" class="ti-btn ti-btn-icon bg-primary text-white font-medium me-[0.365rem]">
                                                <i class="ri-facebook-line font-bold"></i>
                                            </button>
                                            <button aria-label="button" type="button" class="ti-btn ti-btn-icon bg-secondary text-white font-medium me-[0.365rem]">
                                                <i class="ri-twitter-line font-bold"></i>
                                            </button>
                                            <button aria-label="button" type="button" class="ti-btn ti-btn-icon bg-warning text-white font-medium me-[0.365rem]">
                                                <i class="ri-instagram-line font-bold"></i>
                                            </button>
                                            <button aria-label="button" type="button" class="ti-btn ti-btn-icon bg-success text-white font-medium me-[0.365rem]">
                                                <i class="ri-github-line font-bold"></i>
                                            </button>
                                            <button aria-label="button" type="button" class="ti-btn ti-btn-icon bg-danger text-white font-medium">
