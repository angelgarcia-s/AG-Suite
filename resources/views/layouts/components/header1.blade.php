                    ...
                    <div class="main-header-container ps-[0.725rem] pe-[1rem] ">
                        ...
                        <div class="header-content-right">
                            ...
                            <div class="main-header-dropdown bg-white !-mt-3 !p-0 hs-dropdown-menu ti-dropdown-menu w-[22rem] border-0 border-defaultborder hidden"
                                ...
                                <p class="text-defaulttextcolor  !text-[1.0625rem] font-semibold">Cart Items</p>
                                ...
                                <li class="ti-dropdown-item border-b border-defaultborder ">
                                    ...
                                    <div class="grow">
                                        ...
                                        <div class="mb-0 !text-[0.8125rem] text-[#232323] font-semibold">
                                            <a href="{{url('cart')}}">SomeThing Phone</a>
                                        </div>

                                        <div class="inline-flex">
                                            <span class="text-black mb-1 !font-medium">$1,299.00</span>
                                ...
                                <li class="ti-dropdown-item border-b border-defaultborder">
                                    ...
                                    <div class="grow">
                                        ...
                                        <div class="inline-flex">
                                            <span class="text-black !font-medium mb-1">$179.29</span>
                                            <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                                class="ti ti-trash"></i></a>
                                        </div>
                                        </div>
                                ...
                                <li class="ti-dropdown-item border-b border-defaultborder">
                                    ...
                                    <div class="grow">
                                        ...
                                        <div class="inline-flex">
                                            <span class="text-black !font-medium mb-1">$29.00</span>
                                            <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                                class="ti ti-trash"></i></a>
                                        </div>
                                        </div>
                                ...
                                <li class="ti-dropdown-item border-b border-defaultborder">
                                    ...
                                    <div class="grow">
                                        ...
                                        <div class="inline-flex">
                                            <span class="text-black !font-medium mb-1">$4,999.00</span>
                                            <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                                class="ti ti-trash"></i></a>
                                        </div>
                                        </div>
                                ...
                                <li class="ti-dropdown-item">
                                    ...
                                    <div class="grow">
                                        ...
                                        <div class="inline-flex">
                                            <span class="text-black !font-medium mb-1">$129.00</span>
                                            <a aria-label="anchor" href="javascript:void(0);" class="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                                class="ti ti-trash"></i></a>
                                        </div>
                                        </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <h6 class="font-bold mb-1 mt-3 text-[1rem] text-defaulttextcolor">Your Cart is Empty</h6>
                                    <span class="mb-3 !font-normal text-[0.8125rem] block text-defaulttextcolor">Add some items to make me happy :)</span>
                            ...
                            <!-- Related Apps -->
                            <div class="header-element header-apps py-[1rem] md:px-[0.65rem] px-2 hs-dropdown ti-dropdown md:!block !hidden [--placement:bottom-left]">
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <p class="mb-0 text-defaulttextcolor text-[1.0625rem] font-semibold">Related Apps</p>
                                </div>
                                </div>
                                <div class="dropdown-divider mb-0"></div>
                                <div class="ti-dropdown-divider divide-y divide-gray-200 main-header-shortcuts p-2" id="header-shortcut-scroll">
                                <div class="grid grid-cols-3 gap-2">
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        <div>
                                        ...
                                        <div class="text-[0.75rem] text-defaulttextcolor">Figma</div>
                                        </div>
                                    </a>
                                    </div>
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        ...
                                        <div class="text-[0.75rem] text-defaulttextcolor">Power Point</div>
                                    </a>
                                    </div>
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        ...
                                        <div class="text-[0.75rem] text-defaulttextcolor">MS Word</div>
                                    </a>
                                    </div>
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        ...
                                        <div class="text-[0.75rem] text-defaulttextcolor">Calendar</div>
                                    </a>
                                    </div>
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        ...
                                        class="leading-none text-2xl !h-[1.75rem] !w-[1.75rem] align-middle flex justify-center mx-auto">
                                        <div class="text-[0.75rem] text-defaulttextcolor">Sketch</div>
                                    </a>
                                    </div>
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        ...
                                        class="leading-none text-2xl !h-[1.75rem] !w-[1.75rem] align-middle flex justify-center mx-auto">
                                        <div class="text-[0.75rem] text-defaulttextcolor">Docs</div>
                                    </a>
                                    </div>
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        ...
                                        class="leading-none text-2xl !h-[1.75rem] !w-[1.75rem] align-middle flex justify-center mx-auto">
                                        <div class="text-[0.75rem] text-defaulttextcolor">Google</div>
                                    </a>
                                    </div>
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        ...
                                        class="leading-none text-2xl !h-[1.75rem] !w-[1.75rem] align-middle flex justify-center mx-auto">
                                        <div class="text-[0.75rem] text-defaulttextcolor">Translate</div>
                                    </a>
                                    </div>
                                    <div class="">
                                    <a href="javascript:void(0);" class="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50">
                                        ...
                                        class="leading-none text-2xl !h-[1.75rem] !w-[1.75rem] align-middle flex justify-center mx-auto">
                                        <div class="text-[0.75rem] text-defaulttextcolor">Sheets</div>
                                    </a>
                                    </div>
                                </div>
                                </div>
